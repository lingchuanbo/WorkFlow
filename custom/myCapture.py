...
class MyCapture:
    ...
    def __init__(self):
        ...
        self.capture_text_box.place(x=20, y=50, anchor='nw', width=170, height=330)

        self.translate_text_box = tkinter.Text(window)  # 创建text容器用于存放翻译后的文字
        self.translate_text_box.place(x=210, y=50, anchor='nw', width=170, height=330)
    ...
    def baidu_ocr(self, file_path):
        """ 调用通用文字识别, 图片参数为本地图片 """
        app_id = '18659437'
        api_key = '7U2OgTyTuH5NG2ZAxHZfbfQR'
        secret_key = 'yFklkou5XySgF1WkxBeKmePphkOESFhO'
        ocr_text = ''
