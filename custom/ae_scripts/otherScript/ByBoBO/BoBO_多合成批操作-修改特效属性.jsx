...
//~        var myLayer = "99999.png" ; //素材请用   "素材名" | index 请输出数字
            var LayerNum = 5 ; //素材请用   "素材名" | index 请输出数字

            color=[111,34,198]; // Color 1 //
            colorMid=[111,34,198]; // Color 1 //
            //var myEffect=item.layer(3).property("Effects").addProperty("Deep Glow"); //添加特效
            var myEffect=item.layer(LayerNum).property("Effects").property("Tritone"); //添加特效
            ...
            myEffect.property("Highlights").setValue(color/255); //颜色转换
