...
(function(me){
	...
	var rbIndex = 4;
	//-------------------------------------------------------------------------
	var winObj = ( me instanceof Panel) ? me : new Window("palette", "Composition", [ 0,  0,  144,  190]  ,{resizeable:true, maximizeButton:true, minimizeButton:true});
	//-------------------------------------------------------------------------
	...
	var stWidth = winObj.add("statictext", [  13,   43,   13+  32,   43+  18], "Width");
	stWidth.graphics.font = ScriptUI.newFont("Tahoma",ScriptUI.FontStyle.REGULAR, 11);
	var stHeight = winObj.add("statictext", [  13,   72,   13+  32,   72+  18], "Heigth");
	...
	var stPos = winObj.add("statictext", [  13,   98,   13+  32,   98+  18], "Position");
	var rb = [];
